...
function Step3Report({ report }) {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-pink-950 px-4 sm:px-6 lg:px-10 py-8'>
      <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        ...
        <button onClick={downloadPDF} className='bg-pink-500 hover:bg-pink-600 text-white px-6 py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap'>Download PDF</button>
      </div>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        ...
        <div className='space-y-6'>
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className='bg-slate-900 rounded-2xl sm:rounded-3xl shadow-lg p-6 sm:p-8'>
            ...
            <div className='space-y-5'>
              {
                skills.map((s, i) => (
                  <div key={i}>
                    ...
                    <div className='bg-slate-800 h-2 sm:h-3 rounded-full'>
                      <div className='bg-pink-950 h-full rounded-full'
        ...
        <div className='lg:col-span-2 space-y-6'>
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className='bg-slate-900 rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-8'>
          ...
          <motion.div
            ...
            <div className='space-y-6'>
              {questionWiseScore.map((q, i) => (
                <div key={i} className='bg-slate-900 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-slate-700'>
                  ...
                  <div className='flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4'>
                    ...
                    <div className='bg-pink-950 text-pink-400 px-3 py-1 rounded-full font-bold text-xs sm:text-sm w-fit'>
                      {q.score ?? 0}/10
                    </div>
                  </div>

                  <div className='bg-pink-950 border border-pink-700 p-4 rounded-lg'>
